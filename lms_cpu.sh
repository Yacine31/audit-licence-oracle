...
function get_hostname {
	...
	# si la commande précédente est ne retourne rien, alors on est en présence de Windows
	if [ ! "$HNAME" ]; then
...
function get_modele {
	...
	SunOS )
		...
		# si la commande retourne : prtdiag can only be run in the global zone alors modèle non disponible
